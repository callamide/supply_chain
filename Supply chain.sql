...
-- Find the average transportation day count for each destination port --
select dest_port_cd, avg( )

-- Determine the total cost of storing all products in a specific warehouse--
select .
